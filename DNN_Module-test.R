...
######Save Model and POJO ########
savedDNN_Rand<-h2o.saveModel(dnn_model_r, path = '/0MyDataBases/07 R/ADHOC_Qlikview/H2O_Models_2015', force = TRUE)            
#WriteLog("DNN model saved at "&Runtime&". ")
savedDNN_Rand_POJO<-h2o.download_pojo(dnn_model_r, path = '/0MyDataBases/07 R/ADHOC_Qlikview/POJO_2015', get_jar = TRUE)
