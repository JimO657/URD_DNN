...
infpath='C:\\0MyDataBases\\40Python\URD_DNN\data_2015\ExportFileR.csv'
...
def create_h2o_urd_model(urd_data):
    ...
    save_path = os.path.join('C:\\', '0MyDataBases/40Python/URD_DNN/H2O_Models/')
...
# Import URD data
urd_path = os.path.join('C:\\', '0MyDataBases/40Python/URD_DNN/data/ExportFileR.csv')
...
base_data_path = os.path.join('C:\\', '0MyDataBases/40Python/URD_DNN/data')
