...
#WriteLog("GBM H2O started at "&Runtime&". ")
h2o.removeAll()
...
#WriteLog("GBM about to set variables "&Runtime&". ")
...
#WriteLog("GBM about to set YearStart to mrvStartYear "&Runtime&". ")			            
YearStart<-mrvStartYear 

#'           R.EvaluateNoReturn "YearStart<-2006"
#WriteLog("GBM about to set YearEnd to mrvEndYear "&Runtime&". ")			            
YearEnd<-mrvEndYear 
...
#'''''''''''''''' Start GBM '''''''''''''  
mid<-paste('R_ADHOC','GBM','Data_Since',YearStart,'Data_till',YearEnd,'year_end',sep = '_')
#WriteLog("GBM training started at "&Runtime&". ")
gbm_model_r <- h2o.gbm(model_id = mid, training_frame=train_r.h2o, validation_frame=valid_r.h2o, x=predictors, y=response, ntrees=5000,stopping_metric= 'MSE',stopping_rounds=20,stopping_tolerance=1e-6, score_each_iteration = TRUE)
#''''''''''' Enable Cross Validation 
#'           	R.EvaluateNoReturn "nfolds <- 5" 
#'			R.EvaluateNoReturn "gbm_model_r <- h2o.gbm(model_id = mid, training_frame=train_r.h2o, validation_frame=valid_r.h2o, x=predictors, y=response, ntrees=500, learn_rate=0.01, score_each_iteration = TRUE,seed = 1, nfolds = nfolds, fold_assignment = 'Modulo', keep_cross_validation_predictions = TRUE)"


#WriteLog("GBM training finished at "&Runtime&". ") 

#'''''''''''''''''''' End GBM
#''''''''''' Save Model and POJO ''''''''''''''''
savedGBM_Rand<-h2o.saveModel(gbm_model_r, path = '/0MyDataBases/7R/ADHOC_Qlikview/H2O_Models_2015', force = TRUE)            

savedGBM_Rand_POJO<-h2o.download_pojo(gbm_model_r, path = '/0MyDataBases/7R/ADHOC_Qlikview/POJO_2015', getjar = TRUE)
#'''''''''''''''''''''''''''''''
...
#WriteLog("GBM plot finished at "&Runtime&". ")           
#''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''            
...
#WriteLog("GBM macro finished at "&Runtime&". ") 
#'     MsgBox("GBM Trained Succesfully")     	
#End Sub
#'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
gbm_model_r
plot(gbm_model_r,metric='MSE')
time <- gbm_model_r@model$run_time/1000/60
