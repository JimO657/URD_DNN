...
data_full = pd.read_csv(
    '~/0MyDataBases/7R/ADHOC_Qlikview-linux/data/ExportFileR.csv')
...
data_weather = pd.read_csv('~/0MyDataBases/7R/ADHOC_Qlikview-linux/data/ExportFileWeather_2010.csv')
